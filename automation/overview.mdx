...
description: "Learn about Kalla AI's built-in automation engine for creating workflows without coding"
---
...
Kalla AI includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Kalla AI (e.g., "call ended," "inbound call context injection").
