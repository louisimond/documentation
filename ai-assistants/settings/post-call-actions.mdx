...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://automate.kallaai.com/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from Kalla AI.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from Kalla AI.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.kallaai.com/storage/recordings/call-12345.mp4",
