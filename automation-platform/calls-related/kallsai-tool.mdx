...
title: "Kalla AI Tool"
icon: "phone"
description: "Learn how to use Kalla AI triggers and actions in your AI calling flows"
---

# Kalla AI Tool

The Kalla AI tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Kalla AI tool prominently displayed at the top of the
...
![Kalla AI Call Ended Trigger](/resources/autocalls-trigger.jpg)
...
![Kalla AI Action](/resources/autocalls-action.jpg)
