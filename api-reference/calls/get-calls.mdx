  ...
  "data": [
    {
      ...
      "status": "completed",
      "transcript": "Hello, this is Sarah from Kalla AI. How are you doing today?...",
      "variables": {
      ...
      "total_cost": 0.025,
      "answered_by": "human",
      "recording_url": "https://recordings.kallaai.com/calls/123.mp3",
      "created_at": "2025-08-04 14:30:00",
      "updated_at": "2025-08-04 14:34:05"
    }
  ],
  "first_page_url": "https://app.kallaai.com/api/user/calls?page=1",
  "from": 1,
  "last_page": 10,
  "last_page_url": "https://app.kallaai.com/api/user/calls?page=10",
  "links": [
    {
      "url": null,
    ...
    {
      "url": "https://app.kallaai.com/api/user/calls?page=1",
      "label": "1",
      "active": true
    },
    {
      "url": "https://app.kallaai.com/api/user/calls?page=2",
      "label": "2",
      "active": false
    }
  ],
  "next_page_url": "https://app.kallaai.com/api/user/calls?page=2",
  "path": "https://app.kallaai.com/api/user/calls",
  "per_page": 15,
  "prev_page_url": null,
  "to": 15,
  "total": 150
