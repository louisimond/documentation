...
icon: "phone"
description: "Learn about the different types of phone numbers you can use with Kalla AI: dedicated numbers, SIP integration, and Caller ID"
---

Kalla AI lets you connect three different kinds of phone numbers to your AI assistant:

1. **Normal (Dedicated) Numbers**

   - Rented directly from Kalla AI.
...
2. **SIP Integration (VOIP/PBX)**
   ...
   - This setup allows you to keep your existing numbers while benefiting from Kalla AI's AI.
