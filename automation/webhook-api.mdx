...
If you want deeper customization beyond no-code blocks, Kalla AI supports **webhooks** and a **REST API**.

## 1. Webhooks

- **When to Use**: Trigger events in external systems the moment something happens in Kalla AI (e.g., "Call Ended,").
...
**Note:** You'll find the official API reference in a dedicated docs section or via your Kalla AI dashboard. Always secure your tokens and test endpoints in a dev environment.
