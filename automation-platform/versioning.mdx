...
icon: "clock"
description: "Learn how flow versioning works in Kalla AI"
---

Kalla AI keeps track of all published flows and their versions. Here’s how it works:
...
4. If you try to edit a published flow, Kalla AI will create a new **draft** if there is none and copy the **published** version to the new version.
