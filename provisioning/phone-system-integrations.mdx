...
icon: "phone-office"
description: "Learn how to integrate Kalla AI with your existing PBX or VOIP infrastructure through SIP trunks"
---

For businesses with existing PBX or VOIP infrastructure, Kalla AI can integrate through SIP trunks or direct connections:

## 1. SIP Trunk

- **How It Works**: You share your SIP credentials (server, username, password). Kalla AI configures a trunk internally.
...
- If your PBX already handles call routing, pass the call to Kalla AI only when certain conditions are met (like after IVR selection).
...
- Carrier charges from your PBX provider still apply, plus any Kalla AI usage fees.
